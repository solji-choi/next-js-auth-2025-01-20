...
import com.ll.next_js_2025_01_10.domain.post.comment.controller.ApiV1PostCommentController;
...
public class ApiV1PostCommentControllerTest {
    ...
    void t4() throws Exception {
        ...
        resultActions
                ...
                .andExpect(jsonPath("$.msg").value("%d번 댓글이 등록되었습니다.".formatted(lastPostComment.getId())))
